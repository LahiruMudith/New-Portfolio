    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div
            ref={imageRef}
            className={`flex justify-center mb-8 mt-[20%] md:mt-0 transition-all duration-700 ${imageVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <div ref={titleRef}
            className={`space-y-2 transition-all duration-700 delay-100 ${titleVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground font-light">Full Stack Developer</p>
          </div>
          <div ref={descriptionRef}
            className={`text-muted-foreground max-w-2xl mx-auto leading-relaxed transition-all duration-700 delay-200 ${descriptionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}>
          ...
          <div ref={buttonsRef}
            className={`flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 transition-all duration-700 delay-300 ${buttonsVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}>
          ...
          <div ref={featuresRef}
            className={`flex flex-wrap items-center justify-center gap-6 pt-8 text-sm text-muted-foreground transition-all duration-700 delay-500 ${featuresVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}>
